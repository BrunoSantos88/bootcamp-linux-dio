...
tiver com dificuldades com banco de Dados , opitei por criar um rds e usar o endpoint.
...
Criar e Python connector , usar endpont e database e senha do banco de dados, funciona do mesmo jeito.
